...
(function () {
  ...
  /**ngInject*/
  function loginController($rootScope,$location,$cookies,userService, $log, securityService)
  {
    ...
    vm.login = function () {
      ...
      securityService.authenticate(serializeData({username:vm.username,password:vm.password}),
